...
public class ExcelHandler {
	...
	public static void setExcelFile(String Path,String SheetName) throws Exception {
		...
		try {
			...
			// Open the Excel file
			//System.getProperty("ResourcesBaseFolder")+ System.getProperty("TestDataFolder") +Path + ".xlsx");
			FileInputStream ExcelFile = new FileInputStream(System.getProperty("ResourcesBaseFolder")+ System.getProperty("TestDataFolder") +Path + ".xlsx");
	...
	public static void closeexcel(String Path) throws IOException
	{
		...
		try {
			...
			FileOutputStream fileOut = new FileOutputStream(System.getProperty("ResourcesBaseFolder")+ System.getProperty("TestDataFolder") +Path + ".xlsx");
